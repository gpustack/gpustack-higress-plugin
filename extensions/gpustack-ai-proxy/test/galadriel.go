...
// Upstream: https://github.com/alibaba/higress/blob/aae6fbce36a2d1dd7afff007a265ecbebdd8a6f1/plugins/wasm-go/extensions/ai-proxy/test/galadriel.go
...
func RunGaladrielOnHttpRequestHeadersTests(t *testing.T) {
	test.RunTest(t, func(t *testing.T) {
		...
		t.Run("galadriel chat completion request headers", func(t *testing.T) {
			...
			require.Contains(t, authValue, "Bearer gal-test123456789", "Authorization should contain Galadriel bearer token")
		...
		t.Run("galadriel models request headers", func(t *testing.T) {
			...
			// Current ai-proxy header handling buffers requests for body-aware providers.
			require.Equal(t, types.HeaderStopIteration, action)
